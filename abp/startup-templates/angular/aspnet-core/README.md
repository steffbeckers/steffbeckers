...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p a9a4c5ad-67f0-4284-94b6-83cd31db152f
```

> `a9a4c5ad-67f0-4284-94b6-83cd31db152f` is the password of the certificate, you can change it to any password you want.
